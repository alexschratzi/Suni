...
import { ReadonlyField, SectionLabel } from "./EditorCommon";
  ...
  return (
    <View>
      <ReadonlyField
        ...
        onPress={
          isIcalEditing ? undefined : () => onSetActivePicker(activePicker === "from" ? null : "from")
        }
      />
      ...
      <ReadonlyField
        ...
        onPress={
          isIcalEditing ? undefined : () => onSetActivePicker(activePicker === "until" ? null : "until")
        }
      />
...
export function CourseFields({
  ...
  return (
    <View>
      ...
      <TextInput mode="outlined" value={form.courseName ?? ""} onChangeText={(t) => onChangeCourseField({ courseName: t })} dense />

      <SectionLabel>Course Type</SectionLabel>
      <TextInput mode="outlined" value={form.courseType ?? ""} onChangeText={(t) => onChangeCourseField({ courseType: t })} dense />

      <SectionLabel>Lecturer</SectionLabel>
      <TextInput mode="outlined" value={form.lecturer ?? ""} onChangeText={(t) => onChangeCourseField({ lecturer: t })} dense />

      <SectionLabel>Room</SectionLabel>
      <TextInput mode="outlined" value={form.room ?? ""} onChangeText={(t) => onChangeCourseField({ room: t })} dense />
    </View>
  );
}
...
export function PartyFields({
  ...
  return (
    <View>
      ...
      <TextInput mode="outlined" value={form.eventName ?? ""} onChangeText={(t) => onChangePartyField({ eventName: t })} dense />

      <SectionLabel>Location</SectionLabel>
      <TextInput mode="outlined" value={form.location ?? ""} onChangeText={(t) => onChangePartyField({ location: t })} dense />

      <SectionLabel>Event Created By</SectionLabel>
      <TextInput mode="outlined" value={form.createdBy ?? ""} onChangeText={(t) => onChangePartyField({ createdBy: t })} dense />

      <SectionLabel>Entry fee</SectionLabel>
      <TextInput mode="outlined" value={form.entryFee ?? ""} onChangeText={(t) => onChangePartyField({ entryFee: t })} dense />

      <SectionLabel>Invited Groups (comma separated)</SectionLabel>
      <TextInput mode="outlined" value={form.invitedGroups ?? ""} onChangeText={(t) => onChangePartyField({ invitedGroups: t })} dense />
    </View>
  );
}
